...
insert into couurse(name, credits, professorId) values('Introduction to Programming', 3, 1);
insert into couurse(name, credits, professorId) values('Quantum Mechanics', 4, 2);
insert into couurse(name, credits, professorId) values('Calculus', 4, 3);
